...
return(
  <div className="header" >
     ...
     <label  className="checkBtn" onClick={()=>{      
     ...
     <div className="headerLink Hide">
        <ul>
    <li className="tags"><Link to="/">{props.one}</Link></li>
    <li className="tags"><Link to="/canvas">{props.two}</Link></li> 
    <li className="tags"><Link to="/collaborate">{props.three}</Link></li>
        </ul>
     </div>
    
     <div className="headerLog Hide">
         <ul>
    <li className="tags"><Link to="/login">{props.four}</Link></li>
         </ul>
     </div>
